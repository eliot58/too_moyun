...
const Gallery: FC<IGalleryData> = ({gallery}) => {
	...
	return <div className='text-center laptop:my-24 my-5 flex flex-col items-center'>
		<h2 className='text-2xl font-bold mb-16'>Галерея</h2>
		...
		<Link href='/photoGallery' className='w-64 text-xl bg-blue-600 px-2 py-3 rounded-md'>Фотографияларга отуу</Link>
	</div>
}
