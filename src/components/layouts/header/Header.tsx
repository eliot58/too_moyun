...
const Header: FC = () => {
	...
	return (
		<div>
			<header className='flex items-center bg-white w-full laptop:pt-12 pt-2 laptop:px-7 px-5 laptop:justify-center justify-between text-lg pb-8'>
				...
				<div className='flex w-full items-center laptop:justify-between laptop:flex-row flex-row-reverse'>
					{size.width === undefined ? (
						...
						<div className='mx-2 mt-0 flex justify-between w-3/4 mr-2'>
							<Link
								href='/'
