...
const Home: FC = () => {
  ...
  return (
    ...
    <div className="text-center w-full">
        <div className="bg-gray-50 flex laptop:justify-center justify-start laptop:mt-0 mt-0 py-5 flex-col items-center">
        <h1 className='text-red-600 text-xl font-bold laptop:mb-7 mb-4 mt-3'>Жарыялар</h1>
