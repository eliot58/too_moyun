...
const GarPageId: FC<idCard> = (id) => {
	...
	return <div>
		<div className='flex flex-col items-center mb-20 px-20'>
			<Image className='mb-10' src={cardEl[0] === undefined ? "" : typeof cardEl[0].img === 'string' ? cardEl[0].img : ""} alt='' width={388} height={388}/>
			<p className='text-2xl font-bold text-cardColor mb-6'>{cardEl[0] === undefined ? '' :cardEl[0].title}</p>
