	...
	return (
		<div>
			<div className='relative laptop:w-40 w-28 laptop:text-lg text-sm text-start'>
					<select className='laptop:w-40 w-28 pl-0 pt-0 text-white bg-navColor laptop:text-lg text-sm  border-none outline-none appearance-none focus:border-white text-lg' onChange={event =>handleChange(event.target.value)}>
